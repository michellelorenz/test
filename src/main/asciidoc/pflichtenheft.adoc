...
|Auslöser                   |Benutzer wählt "Kunden" in der Navigationsleiste
|Vorbedingung(en)          a|
...
|Akteure                    |Mitarbeiter, Geschäftsführung
|Auslöser                   |Benutzer wählt "Bestellungen" in der Navigationsleiste
|Vorbedingung(en)          a|
- Benutzer ist authentifiziert und hat die Rolle "Mitarbeiter" oder "Geschäftsführung".
|Hauptschritte             a|
1. Benutzer wählt "Bestellungen" in der Navigationsleiste.
2. Die komplette Liste aller abgeschlossenen Bestellungen wird angezeigt.
|Erweiterungen              |-
|Funktionale Anforderungen  | <<F0070>>
|===
...
|Akteure                    |Mitglied
|Auslöser                   |Mitglied besucht die Webseite
|Vorbedingung(en)          a|
- Keine.
|Hauptschritte             a|
1. Mitglied besucht die Webseite.
2. Mitglied sieht die aktuellen Nachrichten und Informationen.
|Erweiterungen              |-
...
|Akteure                    |Trainer
|Auslöser                   |Trainer wählt "Trackingsystem" im System
|Vorbedingung(en)          a|
- Trainer ist authentifiziert.
|Hauptschritte             a|
1. Trainer wählt "Trackingsystem" im System.
2. Trainer trägt Datum, Ort, Anfangs- und Endzeit sowie die Anwesenheit der Teilnehmer ein.
|Erweiterungen              |-
...
|===
|ID                         |**<<UC013>>**
|Name                       |Trainingsgruppen anzeigen und erstellen
...
|Auslöser                   |Benutzer wählt "Trainingsgruppen" im System
|Vorbedingung(en)          a|
- Benutzer ist authentifiziert und hat die Rolle "Trainer" oder "Teamersteller".
|Hauptschritte             a|
1. Benutzer wählt "Trainingsgruppen" im System.
2. Benutzer kann Trainingsgruppen einsehen, erstellen und verwalten.
|Erweiterungen              |-
