...
:project_name: SWT23W10_Kletterverein
== __{project_name}__
...
|0.3     | Final       | 09.11.2023          | SWT23W10    |  Abgabe
|===
...
|{Pre}        a|Der Benutzer ist authentifiziert. Der Benutzer hat die Rolle "Verwalter".
|{Event}      a|Der Benutzer wählt die Option "Produkt hinzufügen" im System, gibt die notwendigen Produktinformationen ein und bestätigt das Hinzufügen. 
|{Result}     a|Das neue Produkt wird im System hinzugefügt.
|===
...
|{Pre}        a|Der Benutzer ist authentifiziert. Der Benutzer hat die Rolle "Verwalter". Im System existiert mindestens ein registriertes Produkt.
|{Event}      a|Der Benutzer wählt das zu löschende Produkt aus. Der Benutzer wählt die Option "Produkt löschen" und bestätigt seine Eingabe.
|{Result}     a|Das gewählte Produkt wird aus dem System gelöscht.
|===
...
|{Pre}        a|Der Benutzer ist authentifiziert. Der Benutzer hat die Rolle "Verwalter". Im System existiert mindestens ein registriertes Produkt.
|{Event}      a|Der Benutzer wählt das zu bearbeitende Produkt aus. Der Benutzer wählt die Option "Produkt bearbeiten" und bearbeitet die gewünschte Produktinformation. Anschließend bestätigt er seine Änderung.
|{Result}     a|Das gewählte Produkt wird mit den neuen Produktinformationen im System gespeichert.
|===
...
|===
|ID            |<<AT0280>>
|Anwendungsfall|<<UC028>>
|{Pre}        a|Der Benutzer ist registriert, eingeloggt und hat die Rolle "Mitglied".
|{Event}      a|Der Benutzer navigiert zum Profil. 
|{Result}     a|Das System zeigt die Profildaten an.
|===

[cols="1h, 4"]
|===
|ID            |<<AT0291>>
|Anwendungsfall|<<UC029>>
|{Pre}        a|Der Benutzer ist registriert, bestätigt, eingeloggt und hat die Rolle "Mitglied" sowie eine Mitgliedsnummer.
|{Event}      a|Der Benutzer navigiert zu "Profil kündigen" und bestätigt die Kündigung.
|{Result}     a|Das System leitet die Kündigung an den Verwalter weiter.
|===
...
|ID            |<<AT0292>>
|Anwendungsfall|<<UC029>>
|{Pre}        a| Der Benutzer ist authentifiziert. Der Benutzer hat die Rolle "Verwalter". Es existiert mindestens ein Mitglied, das seine Kündigung bestätigt hat. Der Benutzer navigiert zum betroffenen Profil und wählt die Option "Löschen".
|{Event}      a|Der Benutzer bestätigt die Kündigung des Mitglieds durch das Bestätigen des Löschens des dazugehörigen Profils.
|{Result}     a|Das System löscht die Daten des Profils.
|===

[cols="1h, 4"]
|===
|ID            |<<AT0300>>
|Anwendungsfall|<<UC030>>
|{Pre}        a| Der Benutzer ist authentifiziert und hat die Rolle "Verwalter". Es existiert mindestens ein Mitglied.
|{Event}      a|Der Benutzer weißt dem Mitglied eine neue Zuständigkeit zu.
|{Result}     a|Das System überschreibt die alte Zuständigkeit des Mitglieds mit der neu zugewiesenen.
|===

[cols="1h, 4"]
|===
|ID            |<<AT0310>>
|Anwendungsfall|<<UC031>>
|{Pre}        a| Der Benutzer hat die Rolle "Mitglied", hat ein Profil und ist eingeloggt. 
|{Event}      a|Der Benutzer navigiert im Shop zum Warenkorb. Im Warenkorb wählt der Nutzer die Option "Warenkorb leeren" und bestätigt dies.
|{Result}     a|Das System leert den Warenkorb.
|===

[cols="1h, 4"]
|===
|ID            |<<AT0320>>
|Anwendungsfall|<<UC032>>
|{Pre}        a| Der Benutzer ist authentifiziert und hat die Rolle "Verwalter der öffentlichen Kommunikation". Es wurde bereits eine Nachricht hochgeladen.
|{Event}      a|Der Benutzer navigiert zur Option "Nachricht bearbeiten", bearbeitet die Nachricht und bestätigt die Änderung.
|{Result}     a|Das System speichert die Änderung.
|===

[cols="1h, 4"]
|===
|ID            |<<AT0330>>
|Anwendungsfall|<<UC033>>
|{Pre}        a| Der Benutzer ist authentifiziert und hat die Rolle "Verwalter der öffentlichen Kommunikation". Es wurde bereits eine Nachricht hochgeladen.
|{Event}      a|Der Benutzer navigiert zur Option "Nachricht löschen" und bestätigt die Änderung.
|{Result}     a|Das System löscht die betroffene Nachricht.
|===
