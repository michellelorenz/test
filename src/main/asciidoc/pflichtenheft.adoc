...
Das Produkt existiert im System.
|Hauptschritte a|
Verwalter wählt das Produkt aus, das er bearbeiten möchte.
Verwalter wählt die Option "Produkt bearbeiten".
Verwalter ändert die gewünschten Produktinformationen.
Verwalter bestätigt die Änderungen.
|Erweiterungen |-
...
Das Produkt existiert im System.
|Hauptschritte a|
Verwalter wählt das Produkt aus, das er löschen möchte.
Verwalter wählt die Option "Produkt löschen".
Das System fragt zur Bestätigung, ob das Produkt wirklich gelöscht werden soll.
Verwalter bestätigt das Löschen des Produkts.
|Erweiterungen |-
|Funktionale Anforderungen | <<F0171>>
|===
[cols="1h,3"]
...
|Funktionale Anforderungen | <<F0172>>
|===
== Funktionale Anforderungen (Fortsetzung)
...
|Produkt anlegen
a|
Das System muss dem Verwalter die Möglichkeit bieten, ein neues Produkt zum System hinzuzufügen, indem er die notwendigen Produktinformationen eingibt.

|[[F0171]]<<F0171>>
|v1.0
|Produkt löschen
a|
Das System muss dem Verwalter die Möglichkeit bieten, ein bestehendes Produkt aus dem System zu entfernen. Dabei sollte eine Bestätigungsabfrage erfolgen, um versehentliche Löschungen zu vermeiden.

|[[F0172]]<<F0172>>
|v1.0
|Produkt bearbeiten
a|
Das System muss dem Verwalter die Möglichkeit bieten, die Informationen eines bestehenden Produkts im System zu bearbeiten. Dabei sollten alle relevanten Produktinformationen bearbeitet werden können.
